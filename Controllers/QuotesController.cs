...
using QuotesSite.Models;

namespace QuotesSite.Controllers
{
    public class QuotesController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("QuoteId,QuoteText,Author,Date,Subject,Citation")] Quote quote)
        {
            if (id != quote.QuoteId)
            {
                return NotFound();
